...
{
       0,   101,   101,   108,   112,   118,   117,   135,   138,   144,
     156,   160,   166,   170,   174,   178,   182,   187,   193,   201,
     206
};
#endif
...
#line 207 "bison.y" /* yacc.c:1646  */
  ...
  out_code << "= " << symbol_table[0].declarations[0].name.c_str() <<", " << (yyvsp[0].op_val) << endl;
}
